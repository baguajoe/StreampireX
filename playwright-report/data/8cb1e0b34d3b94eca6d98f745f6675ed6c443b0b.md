...
- main:
  ...
  - link "⚙️ Settings":
    - /url: /settings
  - heading "📻 Radio Station Dashboard" [level=1]
  - paragraph: Manage your stations, tracks, and broadcasts
  - text: 💰
  - heading "Earnings" [level=3]
  - paragraph: $0
  - text: +12% this week 👥
  - heading "Followers" [level=3]
  - paragraph: "0"
  - text: +19 today ⚫
  - heading "Status" [level=3]
  - paragraph: Offline
  - text: Ready to stream 📻
  - heading "Stations" [level=3]
  - paragraph: "0"
  - text: Total created
  - heading "Your Radio Stations" [level=2]
  - link "➕ Create New Station":
    - /url: /create-radio
  - text: 📻
  - heading "No stations yet" [level=3]
  - paragraph: Create your first radio station to start broadcasting
  - link "Create Your First Station":
    - /url: /create-radio
- contentinfo:
  - paragraph:
    - text: Made with  by
