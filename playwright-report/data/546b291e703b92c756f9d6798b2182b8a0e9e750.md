...
- link "⚙️ Settings":
  - /url: /settings
- main:
  - heading "🎶 Create New Release" [level=2]
  - text: Track Title
  - textbox: Electronic Odyssey
  - text: Genre
  - textbox
  - text: Release Date
  - textbox
  - text: Select Uploaded Track
  - combobox:
    - option "-- Choose Track --" [selected]
  - checkbox
  - text: Explicit Content Cover Art (JPG or PNG)
  - button "Choose File"
