...
- link "⚙️ Settings":
  - /url: /settings
- main:
  - heading "🎙️ Label Dashboard" [level=3]
  - paragraph: Manage your artists and uploads from one place.
  - strong: "Total Artists:"
  - text: "0"
  - strong: "Status:"
  - text: Active
  - heading "👥 Your Artists" [level=3]
  - text: 🎤
  - heading "No Artists Yet" [level=4]
  - paragraph: Start building your label by adding artists to your roster.
  - button "➕ Add Your First Artist"
  - heading "➕ Artist Management" [level=3]
  - button "➕ Add New Artist"
  - heading "💸 Revenue Split" [level=3]
  - link "📊 View Revenue Breakdown":
    - /url: /revenue-dashboard
    - button "📊 View Revenue Breakdown"
  - heading "📦 Upload on Behalf" [level=3]
  - link "🎵 Upload Content":
    - /url: /upload?as=label
    - button "🎵 Upload Content"
  - heading "🔧 Label Tools" [level=3]
  - link "📈 Analytics Overview":
    - /url: /analytics
    - button "📈 Analytics Overview"
  - link "📋 Contracts & Agreements":
    - /url: /contracts
    - button "📋 Contracts & Agreements"
  - link "⚙️ Label Settings":
    - /url: /label-settings
    - button "⚙️ Label Settings"
- contentinfo:
  - paragraph:
    - text: Made with  by
