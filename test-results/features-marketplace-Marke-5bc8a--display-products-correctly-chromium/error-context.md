...
- link "⚙️ Settings":
  - /url: /settings
- main:
  - heading "🛍 Artist Merch Store" [level=1]
  - img "Test Physical Product"
  - heading "Test Physical Product" [level=3]
  - paragraph: A test physical product for marketplace testing
  - paragraph:
    - strong: $25.99
  - button "Buy Now"
  - img "Test Digital Product"
  - heading "Test Digital Product" [level=3]
  - paragraph: A test digital product for marketplace testing
  - paragraph:
    - strong: $9.99
  - button "Buy Now"
  - img "Artist T-Shirt"
  - heading "Artist T-Shirt" [level=3]
  - paragraph: Official artist merchandise t-shirt
  - paragraph:
    - strong: $19.99
  - button "Buy Now"
- contentinfo:
