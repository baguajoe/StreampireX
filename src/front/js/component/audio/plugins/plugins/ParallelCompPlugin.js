...
export const createParallelCompPlugin = (context, p = {}) => {
  ...
  comp.threshold.value=p.threshold??-10; comp.ratio.value=p.ratio??2; comp.knee.value=3; comp.attack.value=0.005; comp.release.value=0.1;
  const mix=(p.blend??100)/100;
