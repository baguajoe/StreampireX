// =============================================================================
// GraphicEQ5BandPlugin.js — StreamPireX 5-Band Graphic EQ
// Bands: 80, 400, 1000, 4000, 12000 Hz
// =============================================================================

export const createGraphicEQ5BandPlugin = (context, p = {}) => {
  const input  = context.createGain();
  const output = context.createGain();
  const FREQS  = [80, 400, 1000, 4000, 12000];
