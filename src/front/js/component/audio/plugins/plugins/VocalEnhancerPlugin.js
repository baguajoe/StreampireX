...
export const createVocalEnhancerPlugin = (context, p = {}) => {
  ...
  presence.type='peaking'; presence.frequency.value=3500; presence.gain.value=p.presence??0; presence.Q.value=1;
  air.type='highshelf'; air.frequency.value=12000; air.gain.value=p.air??0;
  body.type='peaking'; body.frequency.value=250; body.gain.value=p.body??0; body.Q.value=0.8;
