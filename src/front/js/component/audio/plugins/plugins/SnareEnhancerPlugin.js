...
export const createSnareEnhancerPlugin = (context, p = {}) => {
  ...
  body.type='peaking'; body.frequency.value=200; body.gain.value=p.body??0; body.Q.value=1;
  snap.type='peaking'; snap.frequency.value=1000; snap.gain.value=p.snap??0; snap.Q.value=2;
  air.type='highshelf'; air.frequency.value=8000; air.gain.value=p.air??0;
