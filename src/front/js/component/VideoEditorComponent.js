...
TIMELINE
  ...
  }, [isPlaying, duration, tracks, speedRampPoints]);
  ...
  const menuItems = {
    file: {
      ...
      items: [
        ...
        { label: 'New Sequence...', shortcut: 'Ctrl+N', action: () => setShowNewSequenceDialog(true) },
  ...
  return (
    <div className="video-editor-pro">
      ...
      <div ref={menuBarRef} className="editor-navbar">
        ...
        <div className="project-title" style={{ display:'flex', alignItems:'center', gap:8 }}>
