                        ...
                        <div className="daw-ch-fader-area">
                          <div className="daw-ch-fader-row">
                            ...
                            <div className="daw-ch-fader">
                              <input type="range" min={0} max={SLIDER_MAX} step={1} value={volumeToFader(t.volume ?? 1.0)} onChange={e => { const v = faderToVolume(parseFloat(e.target.value)); updateTrack(i, { volume: v }); const audible = !t.muted && (!hasSolo || t.solo); if (trackGainsRef.current[i]) trackGainsRef.current[i].gain.value = audible ? v : 0; }}/>
                            </div>
                  ...
                  <div className={"daw-channel master-channel" + (selectedTrack === -1 ? " selected" : "")} onClick={() => { console.log("Master clicked! Current selectedTrack:", selectedTrack); setSelectedTrack(-1); }}>
                    ...
                    <div className="daw-ch-fader-area">
                      <div className="daw-ch-fader-row">
                        <div className="daw-ch-db-scale" style={{textAlign:"right"}}><span>+6</span><span>0</span><span>-6</span><span>-12</span><span>-18</span><span>-∞</span></div>
                        <div className="daw-ch-fader">
                          <input type="range" min={0} max={SLIDER_MAX} step={1} value={volumeToFader(masterVolume ?? 1.0)} onChange={e => { const v = faderToVolume(parseFloat(e.target.value)); setMasterVolume(v); if (masterGainRef.current) masterGainRef.current.gain.value = v; }}/>
                        </div>
                  ...
                  <div key={t.id} className={"daw-channel"+(selectedTrack===i?" selected":"")+(t.armed?" armed":"")+(t.trackType==="bus"?" bus-channel":"")+(selectedChannels.has(t.id)?" linked":"")} onClick={e=>{if(e.ctrlKey||e.metaKey){setSelectedChannels(prev=>{const n=new Set(prev);n.has(t.id)?n.delete(t.id):n.add(t.id);return n;});}else setSelectedTrack(i);}} onContextMenu={e=>{e.preventDefault();setChannelCtxMenu({x:e.clientX,y:e.clientY,trackId:t.id,trackIndex:i});}}>
                    ...
                    <div className="daw-ch-fader-area">
                      <div className="daw-ch-fader-row">
                        <div className="daw-ch-db-scale" style={{textAlign:"right"}}><span>+6</span><span>0</span><span>-6</span><span>-12</span><span>-18</span><span>-∞</span></div>
                        <div className="daw-ch-fader">
                          <input type="range" min="0" max={SLIDER_MAX} step="1" value={volumeToFader(t.volume)}
                            onChange={e => { const v = faderToVolume(parseFloat(e.target.value)); updateTrack(i, { volume: v }); const audible = !t.muted && (!hasSolo || t.solo); if (trackGainsRef.current[i]) trackGainsRef.current[i].gain.value = audible ? v : 0; }}/>
                        </div>
                        <CubaseMeter leftLevel={meter.left || 0} rightLevel={meter.right || 0} height={180} showScale={false}/>
                        <div className="daw-ch-meter-scale"><span>0</span><span>-6</span><span>-12</span><span>-18</span><span>-24</span><span>-∞</span></div>
                      </div>
              ...
              <div className={"daw-channel master-channel" + (selectedTrack === -1 ? " selected" : "")} onClick={() => { console.log("Master clicked! Current selectedTrack:", selectedTrack); setSelectedTrack(-1); }}>
                ...
                <div className="daw-ch-fader-area">
                  <div className="daw-ch-fader-row">
                        <div className="daw-ch-db-scale" style={{textAlign:"right"}}><span>+6</span><span>0</span><span>-6</span><span>-12</span><span>-18</span><span>-∞</span></div>
                    <div className="daw-ch-fader">
                      <input type="range" min="0" max={SLIDER_MAX} step="1" value={volumeToFader(masterVolume)}
                        onChange={e => { const v = faderToVolume(parseFloat(e.target.value)); setMasterVolume(v); if (masterGainRef.current) masterGainRef.current.gain.value = v; }}/>
                    </div>
                    <CubaseMeter leftLevel={masterMeterLevels?.left || 0} rightLevel={masterMeterLevels?.right || 0} height={180} showScale={false}/>
                        <div className="daw-ch-meter-scale"><span>0</span><span>-6</span><span>-12</span><span>-18</span><span>-24</span><span>-∞</span></div>
                  </div>
