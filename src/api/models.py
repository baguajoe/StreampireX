...
class User(db.Model):
    ...
    printful_access_token = db.Column(db.Text, nullable=True)
    printful_refresh_token = db.Column(db.Text, nullable=True)
    printful_token_type = db.Column(db.String(50), nullable=True)
    printful_token_expires_at = db.Column(db.String(100), nullable=True)
    printful_connected = db.Column(db.Boolean, default=False, nullable=False)
    __tablename__ = 'user'
    __table_args__ = {'extend_existing': True}
...
class RecordingProject(db.Model):
    ...
    master_volume = db.Column(db.Float, nullable=False, default=1.0)
    ...
    def serialize(self):
        return {
            ...
            # ✅ always 0..1
            "master_volume": float(self.master_volume or 1.0),
...
class StudioTrack(db.Model):
    ...
    volume = db.Column(db.Float, nullable=False, default=1.0)
...
class Product(db.Model):
    ...
    category = db.Column(db.String(50), default="physical")
    ...
    product_type = db.Column(db.String(50), default='physical', nullable=False)
    is_printful = db.Column(db.Boolean, default=False, nullable=False)
    printful_product_id = db.Column(db.String(100), nullable=True)
    printful_variant_id = db.Column(db.String(100), nullable=True)
    artwork_url = db.Column(db.String(500), nullable=True)
    mockup_url = db.Column(db.String(500), nullable=True)
    printful_sync_status = db.Column(db.String(50), default='not_synced', nullable=False)
...
class Tip(db.Model):
    ...
    is_printful = db.Column(db.Boolean, default=False, nullable=False)
    printful_order_id = db.Column(db.String(100), nullable=True)
    fulfillment_status = db.Column(db.String(50), default='pending', nullable=False)
    shipping_name = db.Column(db.String(255), nullable=True)
    shipping_address1 = db.Column(db.String(255), nullable=True)
    shipping_city = db.Column(db.String(120), nullable=True)
    shipping_state = db.Column(db.String(120), nullable=True)
    shipping_country = db.Column(db.String(120), nullable=True)
    shipping_zip = db.Column(db.String(40), nullable=True)
...
class SamplerProject(db.Model):
    ...
    master_volume = db.Column(db.Float, default=1.0)        # 0..1 like RecordingProject
...
class VectorProject(db.Model):
    __tablename__ = "vector_project"

    id = db.Column(db.Integer, primary_key=True)
    user_id = db.Column(db.Integer, nullable=True, index=True)
    name = db.Column(db.String(255), nullable=False, default="Untitled Vector")
    width = db.Column(db.Integer, nullable=False, default=1200)
    height = db.Column(db.Integer, nullable=False, default=1200)
    background = db.Column(db.String(32), nullable=True, default="#10161f")
    data_json = db.Column(db.Text, nullable=False, default="{}")
    thumbnail_url = db.Column(db.String(500), nullable=True)
    created_at = db.Column(db.DateTime, server_default=db.func.now())
    updated_at = db.Column(db.DateTime, server_default=db.func.now(), onupdate=db.func.now())
...
class VectorAsset(db.Model):
    __tablename__ = "vector_asset"

    id = db.Column(db.Integer, primary_key=True)
    user_id = db.Column(db.Integer, nullable=True, index=True)
    name = db.Column(db.String(255), nullable=False)
    file_url = db.Column(db.String(500), nullable=False)
    file_type = db.Column(db.String(50), nullable=True, default="svg")
    created_at = db.Column(db.DateTime, server_default=db.func.now())
